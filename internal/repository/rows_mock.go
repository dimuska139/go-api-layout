...
// Source: /home/dimuska139/go/packages/pkg/mod/github.com/jackc/pgx/v4@v4.14.1/rows.go
...
// MockrowLog is a mock of rowLog interface.
type MockrowLog struct {
	ctrl     *gomock.Controller
	recorder *MockrowLogMockRecorder
}

// MockrowLogMockRecorder is the mock recorder for MockrowLog.
type MockrowLogMockRecorder struct {
	mock *MockrowLog
}

// NewMockrowLog creates a new mock instance.
func NewMockrowLog(ctrl *gomock.Controller) *MockrowLog {
	mock := &MockrowLog{ctrl: ctrl}
	mock.recorder = &MockrowLogMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockrowLog) EXPECT() *MockrowLogMockRecorder {
	return m.recorder
}

// log mocks base method.
func (m *MockrowLog) log(ctx context.Context, lvl pgx.LogLevel, msg string, data map[string]interface{}) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "log", ctx, lvl, msg, data)
}

// log indicates an expected call of log.
func (mr *MockrowLogMockRecorder) log(ctx, lvl, msg, data interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "log", reflect.TypeOf((*MockrowLog)(nil).log), ctx, lvl, msg, data)
}

// shouldLog mocks base method.
func (m *MockrowLog) shouldLog(lvl pgx.LogLevel) bool {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "shouldLog", lvl)
	ret0, _ := ret[0].(bool)
	return ret0
}

// shouldLog indicates an expected call of shouldLog.
func (mr *MockrowLogMockRecorder) shouldLog(lvl interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "shouldLog", reflect.TypeOf((*MockrowLog)(nil).shouldLog), lvl)
}
